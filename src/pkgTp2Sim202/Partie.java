        ...
        while (!quit) {
            ...
            if (Adlez.getCristaux()==niveau){
                ...
                if (donnesMonstres.size()==0){
                    ...
                    break;
                }else {//s'il y a des monstres
                    int vieMonstre=0;
                    for (int i=0; i<monstres.size(); i++){
                        //lit chaque monstre dans le arraylist monstre
                        if (monstres.get(i).getHp()!=0){
                            //s'il y a au moins un monstre encore en vie (hp!=0)
                            vieMonstre++;//la variable vieMonstre n'est plus 0
                        }
                    }
                    if (vieMonstre==0){
                        //si vieMonstre est 0, alors tous les monstre sont morts et on passe au prochain niveau
                        //sinon, ce if ne marche pas et on continue la partie.
                        break;
                    }
                }
            }
